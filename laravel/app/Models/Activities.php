...
class Activities extends Model {
    ...
    protected $fillable = [
        'activity_name', 'activity_type', 'short_description', 'main_description', 'created_by', 'clientID', 'assign_by', 'due_date', 'comments', 'status', 'request_accept_extension', 'complete_activity', 'discard_activity', 'projectID', 'sub_status'
    ];
