        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="live-preview">
                    <form id="projectDetails" method="POST" action="{{ route('activity.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row gy-4 mb-2">
                            <div class="col-xxl-6 col-md-6">
                                <label for="activity_name" class="form-label">Activity Name</label>
                                <input type="text" class="form-control" name="activity_name" id="activity_name" required placeholder="{{ __('Enter activity name') }}">
                            ...
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="activity_type" id="activity_type" required placeholder="{{ __('Enter activity type') }}">
                            ...
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <select class="form-control" id="clientID" name="clientID" data-choices data-choices-sorting-false placeholder="{{ __('Select client...') }}">
                                    ...
                                    @foreach($clients as $client)
                                        <option value="{{ $client->id }}" {{ (isset($clientID->clientID) && $clientID->clientID == $client->id) ? 'selected' : '' }} >
                        ...
                        <div class="row gy-4 mb-2">
                            <div class="col-xxl-12 col-md-12">
                                ...
                                <select class="form-control" id="projectID" data-choices data-choices-removeItem name="projectID"  placeholder="{{ __('Select project...') }}">
                                    <option value="">{{ __('Select project...') }}</option>
                                    @foreach($projects as $project)
                                        <option value="{{ $project->id }}" {{ (isset($prjID) && $prjID == $project->id) ? 'selected' : '' }}>{{ $project->project_title }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mt-4">
                            <div class="text-end">
                                ...
                                <a href="{{ route('activities') }}" class="btn btn-dark">Back</a>
                            </div>
                        </div>
                    </form>
                </div>
