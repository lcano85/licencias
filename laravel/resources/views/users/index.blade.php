    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">{{ __('Users List') }}</h4>
                <div class="flex-shrink-0">
                    <a href="{{ route('user.create') }}" class="btn btn-primary btn-sm"> + {{ __('Add User') }}</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row mb-3">
...
<script type="text/javascript">
    function deleteUser(userId) {
        var recID = userId;
        Swal.fire({
            html: '<div class="mt-3"><lord-icon src="https://cdn.lordicon.com/gsqxdxog.json" trigger="loop" colors="primary:#f7b84b,secondary:#f06548" style="width:100px;height:100px"></lord-icon><div class="mt-4 pt-2 fs-15 mx-5"><p class="text-muted mx-4 mb-0">{{ __('Are you Sure You want to Delete this user ?') }}</p></div></div>',
            showCancelButton: !0,
            customClass: {
