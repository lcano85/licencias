    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">{{ __('Create Billing') }}</h4>
            </div>
            <div class="card-body">
                <div class="live-preview">
                    <form id="licensesAgreementsDetails" method="POST" action="{{ route('billing-list.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row gy-4 mb-2">
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="company" id="company" placeholder="{{ __('Enter company') }}" readonly>
                                @error('company') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-xxl-6 col-md-6">
                                <label for="concept" class="form-label">{{ __('Concept') }}</label>
                                <input type="text" class="form-control" name="concept" id="concept" placeholder="{{ __('Enter concept') }}" readonly>
                        ...
                        <div class="row gy-4 mb-2">
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="invoiceDate" id="invoiceDate" placeholder="{{ __('Enter invoice date') }}" readonly>
                                @error('invoiceDate') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-xxl-6 col-md-6">
                                <label for="criterion" class="form-label">{{ __('Criterion') }}</label>
                                <input type="text" class="form-control" name="criterion" id="criterion" placeholder="{{ __('Enter criterion') }}" readonly>
                        ...
                        <div class="row gy-4 mb-2">
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="period" id="period" placeholder="{{ __('Enter period') }}" readonly>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="periodDetails" id="periodDetails" readonly>
                        ...
                        <div class="row gy-4 mb-2">
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="subTotal" id="subTotal" placeholder="{{ __('Enter sub total') }}" readonly>
                                @error('subTotal') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-xxl-6 col-md-6">
                                <label for="vat" class="form-label">{{ __('Vat') }}</label>
                                <input type="text" class="form-control" name="vat" id="vat" placeholder="{{ __('Enter vat') }}" readonly>
                        ...
                        <div class="row gy-4 mb-2">
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="total" id="total" placeholder="{{ __('Enter sub total') }}" readonly>
                                @error('total') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>

                            <div class="col-xxl-6 col-md-6">
                                <label for="balance" class="form-label">{{ __('Balance') }}</label>
                                <input type="text" class="form-control" name="balance" id="balance" placeholder="{{ __('Enter balance') }}">
                        ...
                        <div class="row gy-4 mb-2">
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <select class="form-control" id="supportingDocument" name="supportingDocument" data-choices data-choices-sorting-false placeholder="{{ __('Select Supporting Document...') }}">
                                    ...
                                    <option value="1" >{{ __('Cash Receipt number') }}</option>
                                    <option value="2" >{{ __('Credit Note No') }}</option>
                                </select>
                            ...
                            <div class="col-xxl-6 col-md-6">
                                ...
                                <input type="text" class="form-control" name="documentDetail" id="documentDetail" placeholder="{{ __('Enter document detail') }}">
                        ...
                        <div class="row mt-4">
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary">{{ __('Save Billing') }}</button>
