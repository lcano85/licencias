    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">{{ __('Role') }}</h4>
            </div>
            <div class="card-body">
                <div class="live-preview">
                    <form id="roleDetails" method="POST" action="{{ route('role.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-xxl-12 col-md-12 permissionCheckBox" style="margin-top: 0px;">
                                @foreach($permissions as $value)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="formCheck{{$value->id}}" name="permission[{{$value->id}}]" value="{{$value->id}}">
